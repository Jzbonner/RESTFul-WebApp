        ...
        <div>
          ...
          <Modal isOpen={this.state.modalIsOpen}
              ...
              <Link to={{pathname: '/', search: ''}} style={{ textDecoration: 'none' }}>
                  <Button bsStyle="danger" bsSize="mini" onClick={this.state.closeModal}>
                      <span className="glyphicon glyphicon-plus"></span>
                  </Button>
              </Link>
              <br />
              <fieldset>
                  ...
                  <select id="year" 
                      ...
                      <option value="2021" id="16">2021</option>
                      <option value="2022" id="17">2022</option>
                      <option value="2023" id="18">2023</option>
                  </select>
              </fieldset>
              <br />
        ...
        <div>
          ...
          <Modal isOpen={this.state.modalIsOpen}
              ...
              <div className="button-center">
                  ...
                  <Link to={{pathname: '/', search: ''}} style={{ textDecoration: 'none' }}>
                      <Button bsStyle="success" bsSize="mini" onClick={this.state.closeModal}>
                          Close the Dialog 
                      </Button>
                  </Link>
              </div> 
